...
record = _TopLevelFunctionSurface.record
wait_http = _TopLevelFunctionSurface.wait_http
server_up = _TopLevelFunctionSurface.server_up
spawn_logged = _TopLevelFunctionSurface.spawn_logged
collect_process_output = _TopLevelFunctionSurface.collect_process_output
ensure_servers = _TopLevelFunctionSurface.ensure_servers
safe_step = _TopLevelFunctionSurface.safe_step
close_modals_if_any = _TopLevelFunctionSurface.close_modals_if_any
run_ui_audit = _TopLevelFunctionSurface.run_ui_audit
cleanup = _TopLevelFunctionSurface.cleanup
