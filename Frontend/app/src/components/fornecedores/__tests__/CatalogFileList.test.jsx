...
test('shows empty state when there are no files', () => {
  render(<CatalogFileList files={[]} />);
...
test('shows action column only when handlers are provided and calls them when clicked', async () => {
