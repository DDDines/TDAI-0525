        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="social-login-buttons">
            <a
              ...
              title={socialConfig.google_enabled ? 'Entrar com Google' : 'Login Google indisponivel'}
              onClick={(e) => {
            ...
            <a
              ...
              title={socialConfig.facebook_enabled ? 'Entrar com Facebook' : 'Login Facebook indisponivel'}
              onClick={(e) => {
