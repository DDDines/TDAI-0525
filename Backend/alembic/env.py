...
class _AlembicMigrationEntries:
    @staticmethod
...
run_migrations_offline = _AlembicMigrationEntries.run_migrations_offline
run_migrations_online = _AlembicMigrationEntries.run_migrations_online
