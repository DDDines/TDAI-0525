...
class Settings(BaseSettings):
    ...
    LM_STUDIO_MAX_CONCURRENCY: int = int(os.getenv('LM_STUDIO_MAX_CONCURRENCY', 1))
    LM_STUDIO_REQUEST_TIMEOUT_SECONDS: int = int(os.getenv('LM_STUDIO_REQUEST_TIMEOUT_SECONDS', 120))
    LM_STUDIO_DESCRIPTION_WORD_TARGET: int = int(os.getenv('LM_STUDIO_DESCRIPTION_WORD_TARGET', 50))
    LM_STUDIO_DESCRIPTION_MAX_TOKENS: int = int(os.getenv('LM_STUDIO_DESCRIPTION_MAX_TOKENS', 150))
