...
class _TopLevelFunctionSurface:
    ...
    async def test_ia_generation_facade_delegates_title_generation():
        ...
        result = await facade.gerar_titulos_com_gemini(
            session="db",
            produto_id=1,
            user="u",
        )
        ...
        assert legacy.calls[0][1]["produto_id"] == 1
        assert legacy.calls[0][1]["user"] == "u"
    ...
    async def test_ia_generation_facade_delegates_attribute_suggestions():
        ...
        result = await facade.sugerir_valores_atributos_com_gemini(
            session="db",
            produto_id=2,
            user="x",
        )
...
test_ia_generation_facade_delegates_title_generation = _TopLevelFunctionSurface.test_ia_generation_facade_delegates_title_generation
test_ia_generation_facade_delegates_attribute_suggestions = _TopLevelFunctionSurface.test_ia_generation_facade_delegates_attribute_suggestions
