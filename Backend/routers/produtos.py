...
class _ProdutosCatalogService:
    ...
    def list_produto_ids(self, search: Optional[str], fornecedor_id: Optional[int], categoria: Optional[str], status_enriquecimento_web: Optional[models.StatusEnriquecimentoEnum], status_titulo_ia: Optional[models.StatusGeracaoIAEnum], status_descricao_ia: Optional[models.StatusGeracaoIAEnum], product_type_id: Optional[int], enrichment_scope: Optional[str], current_user: models.User):
        """Return filtered product IDs for bulk-selection workflows."""
        return self._build_product_management_service().list_produto_ids(search=search, fornecedor_id=fornecedor_id, categoria=categoria, status_enriquecimento_web=status_enriquecimento_web, status_titulo_ia=status_titulo_ia, status_descricao_ia=status_descricao_ia, product_type_id=product_type_id, enrichment_scope=enrichment_scope, current_user=current_user)
