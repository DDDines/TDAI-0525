...
class ProductTypesRequestService:
    ...
    def update_attribute_for_product_type(
        ...
        *,
        ...
        """Update attribute for product type."""
...
def update_attribute_for_product_type_endpoint(
    ...
    """Update attribute for product type endpoint."""
    _ = current_user
