...
@router.get("/me/", response_model=List[schemas.UsoIA], summary="Meu Histórico de Uso da IA")
def ler_meu_historico_uso_ia(
    ...
    return crud.get_usos_ia_by_user(db, user_id=current_user.id, skip=skip, limit=limit)
