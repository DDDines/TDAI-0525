...
class _RuntimeCompatibilityHelpers:
    """Static helpers that patch schema gaps in local databases at startup."""
...
ensure_attribute_templates_collect_in_ai = _RuntimeCompatibilityHelpers.ensure_attribute_templates_collect_in_ai
ensure_fornecedores_logo_url = _RuntimeCompatibilityHelpers.ensure_fornecedores_logo_url
