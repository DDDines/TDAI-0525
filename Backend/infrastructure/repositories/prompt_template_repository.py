...
DEFAULT_PROMPT_TEMPLATES: Dict[str, str] = {
    PromptTemplateName.IA_OPENAI_TITLE_SYSTEM: (
        ...
        "Priorize o nome tecnico confirmado, a referencia, a aplicacao, a categoria e a marca quando estiverem presentes. "
        "So mencione montadora, veiculo, compatibilidade automotiva ou linha leve/pesada quando isso estiver explicitamente confirmado no contexto. "
        "Ignore nome de loja, atendimento, WhatsApp, parcelamento, depoimentos, promessas comerciais ou historico institucional. "
    ...
    PromptTemplateName.IA_OPENAI_TITLE_USER: (
        "Nome original do produto: {nome_base}. Nome alternativo coletado: {nome_secundario}. Marca confirmada: {marca}. "
        "Modelo: {modelo}. Categoria: {categoria}. Segmento do item: {segmento_produto}. "
        "Referencia tecnica: {referencia}. Aplicacao: {aplicacao}. Material: {material}. "
        "Conteudo da embalagem: {conteudo}. "
    ...
    PromptTemplateName.IA_OPENAI_DESCRIPTION_SYSTEM: (
        "Voce e um copywriter tecnico para e-commerce. Crie uma descricao clara e estruturada "
        ...
        "So mencione montadora, veiculo, compatibilidade automotiva, linha leve/pesada, painel ou motor quando isso estiver explicitamente confirmado no contexto. "
        "Nao invente historico de empresa, ano de fundacao, tempo de mercado, premios ou credenciais. "
        "Ignore nome de loja, atendimento, WhatsApp, parcelamento, depoimentos, promessas comerciais ou historico institucional. "
        "Formato obrigatorio da resposta: devolva exatamente nesta estrutura textual, sem markdown adicional:\n"
        "{nome_base}\n"
        "Resumo tecnico:\n"
        "<1 ou 2 frases objetivas>\n"
        "Aplicacao:\n"
        "<valor objetivo ou 'Nao informado'>\n"
        "Referencia:\n"
        "<valor objetivo ou 'Nao informado'>\n"
        "Material:\n"
        "<valor objetivo ou 'Nao informado'>\n"
    ...
    PromptTemplateName.IA_OPENAI_DESCRIPTION_USER: (
        "Nome original do produto: {nome_base}. Nome alternativo coletado: {nome_secundario}. Marca confirmada: {marca}. Modelo: {modelo}. "
        "Categoria: {categoria}. Segmento do item: {segmento_produto}. "
        "Referencia tecnica: {referencia}. Aplicacao: {aplicacao}. Material: {material}. Conteudo da embalagem: {conteudo}. "
    ...
    PromptTemplateName.IA_GEMINI_TITLE_USER: (
        ...
        "Ignore nome de loja, atendimento, WhatsApp, parcelamento, depoimentos e historico institucional.\n"
        "Se faltarem variacoes seguras, prefira pequenas variacoes neutras do proprio nome.\n"
        "Nome original: {nome_base}\n"
        "Nome alternativo coletado: {nome_secundario}\n"
        "Marca confirmada: {marca}\n"
        "Modelo: {modelo}\n"
        "Categoria: {categoria}\n"
        "Segmento do item: {segmento_produto}\n"
    ...
    PromptTemplateName.IA_GEMINI_DESCRIPTION_USER: (
        "Escreva uma descricao estruturada de aproximadamente {tamanho_palavras} palavras para o seguinte produto:\n"
        ...
        "So mencione montadora, veiculo, compatibilidade automotiva, linha leve/pesada, painel ou motor quando isso estiver explicitamente confirmado no contexto.\n"
        "Ignore nome de loja, atendimento, WhatsApp, parcelamento, depoimentos e historico institucional.\n"
        "Responda com esta estrutura textual exata:\n"
        "{nome_base}\n"
        "Resumo tecnico:\n"
        "<1 ou 2 frases objetivas>\n"
        "Aplicacao:\n"
