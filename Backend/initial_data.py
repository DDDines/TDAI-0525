...
class InitialDataRuntime:
    ...
    def create_initial_data(self, session: Session):
        """Create initial data and return the resulting payload or entity."""
    ...
    def _ensure_default_roles(*, user_repo: UserRepository) -> Tuple[Optional[Role], Optional[Role]]:
        """Ensure default roles exists or is valid before continuing the flow."""
...
class InitialDataWorkflow:
    ...
    def __init__(self, runtime: Optional[InitialDataRuntime]=None) -> None:
        """Initialize injected dependencies and runtime configuration for Initial Data Workflow."""
...
class _InitialDataEntryPoints:
    ...
    """Represent Initial Data Entry Points and centralize its responsibilities inside this module."""
    @staticmethod
