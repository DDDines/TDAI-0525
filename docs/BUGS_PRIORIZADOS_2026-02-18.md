...
- [ ] `Backend/routers/produtos.py` esta com bloco de imports/definicoes duplicado no topo e precisa limpeza estrutural.
- [ ] Suite de testes legado esta parcialmente desalinhado com contratos atuais de importacao.
